...
public record SharedConstants(String GAME_ID_HEADER, String ERROR_HEADER, String CREATE_GAME_PATH, String CAN_JOIN_PATH,
    ...
    public SharedConstants() {
        this(Constants.GAME_ID_HEADER, Constants.ERROR_HEADER, Constants.CREATE_GAME_PATH, Constants.CAN_JOIN_PATH,
